        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li><a href="/beijingsecgroup/">首页</a></li>
              <li><a href="/beijingsecgroup/activity.jsp">市场动态</a></li>
              <li><a href="/beijingsecgroup/structure.jsp">公司架构</a></li>
              <li><a href="/beijingsecgroup/download.jsp">表格下載</a></li>
              <li><a href="/beijingsecgroup/about-us">关于我们</a></li>
              <li><a href="/beijingsecgroup/contact-us">联络我们</a></li>
